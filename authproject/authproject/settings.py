...
SECRET_KEY = 'django-insecure-4a1!1&mx#yr0nl1&=opm*f_xvscw46w5c0#f#_l#xg-$o6$biq'
...
INSTALLED_APPS = [
    ...
    'authproject_token.apps.AuthprojectTokenConfig',
    'authproject_login.apps.AuthprojectLoginConfig'
]
