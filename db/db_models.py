...
class Users(Base):
    ...
    id: Mapped[int] = mapped_column(primary_key=True,
                                    ...
                                    index=True,
                                    autoincrement=True)
    login: Mapped[str] = mapped_column(type_=String(32),
                                       nullable=False,
                                       unique=True)
    email: Mapped[str] = mapped_column(type_=String(32),
                                       nullable=False,
                                       unique=True)
    pass_hash: Mapped[str] = mapped_column(type_=Text,
                                           nullable=False,
                                           unique=True,)
...
class Token(Base):
    ...
    id: Mapped[int] = mapped_column(type_=Integer,
                                    primary_key=True,
                                    unique=True,
                                    index=True,
                                    autoincrement=True)
    token: Mapped[str] = mapped_column(type_=Text,
                                       unique=True,
                                       nullable=False)
    created: Mapped[datetime.utcnow] = mapped_column(type_=DateTime,
                                                     default=datetime.utcnow)
    live_time: Mapped[int] = mapped_column(type_=Integer,
                                           default=timedelta(
                                               seconds=settings.TOKEN_LIFE_TIME
                                               )
                                           )
    activated: Mapped[bool] = mapped_column(type_=Boolean,
                                            unique=False,
                                            default=False)
    owner_id: Mapped[int] = mapped_column(ForeignKey("users.id"),
                                          type_=Integer,
                                          nullable=False)    
    owner: Mapped["Users"] = relationship(back_populates="tokens")
